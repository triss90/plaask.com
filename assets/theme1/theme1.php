...
<body>
        ...
        <div class="container">
            <div class="row center-tiny start-small">
                <div class="tiny-12 small-4 medium-3 large-3">
                    <img id="t1-about-image" contenteditable="true" class="contenteditable t1-about-image" src="/assets/theme1/avatar.png" alt="Profile Picture of Jonathan Doe">
                </div>
    ...
    <script>var editor = new MediumEditor('.contenteditable');</script>
